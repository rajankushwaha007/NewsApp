            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><Link className="dropdown-item" to={`/?q=Inertainment&language=${language}`}>Inertainment</Link></li>
                  <li><Link className="dropdown-item" to={`/?q=Fashion&language=${language}`}>Fashion</Link></li>
                  <li><Link className="dropdown-item" to={`/?q=Business&language=${language}`}>Business</Link></li>
